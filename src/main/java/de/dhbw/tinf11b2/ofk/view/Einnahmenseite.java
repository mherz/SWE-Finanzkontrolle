...
public class Einnahmenseite extends CustomComponent implements OFKView,ClickListener {
	 ...
	 * visual editor.
	 */
	public Einnahmenseite(String beschreibung, boolean isEinnahme) {
	...
	public void addToKontoBox(String Kontoname){
		kontoBox_1.addItem(Kontoname);
//		kontoBox_2.addItem(Kontoname);
