...
public class Startseite extends CustomComponent implements OFKView, ClickListener{
	...
	private GridLayout buildGridLayout_1() {
		...
		spezialMaskenSeite.setWidth("20%");
		spezialMaskenSeite.setHeight("10&");
		...
		ausgabenSeite.setWidth("20%");
		ausgabenSeite.setHeight("10%");
		...
		kontenSeite.setWidth("20%");
		kontenSeite.setHeight("10%");
