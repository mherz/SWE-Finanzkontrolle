...
public class UeberblickSeite extends CustomComponent implements OFKView,
	...
	public void wechselDich(String[] kategorien, Double[] werte) {
		...
		Chart chart;
		zeitraumSelect = new NativeSelect();
		zeitraumSelect.setCaption("Zeitraum");
		zeitraumSelect.setImmediate(false);
		zeitraumSelect.setWidth("250px");
		zeitraumSelect.setHeight("-1px");
		
		if (ubersichtSheet.getSelectedTab() == ausgabenLayout) {
			
			
			ausgabenLayout.addComponent(zeitraumSelect, "top:92.0%;left:0.0%");
			// Chart
			if (chartSelect.isSelected("ZeitÜberblick")) {
				chart = setChartBar(test3,test4,"ausgaben");
				zeitraumSelect.setVisible(true);
			
			} else {
				zeitraumSelect.setVisible(false);
				chart = setChartBar(test,test2,"ausgaben2");
			}
			ausgabenLayout.addComponent(chart, "top:10.0%;left:0.0%;");
		}
		else if (ubersichtSheet.getSelectedTab() == einnahmenLayout) {
			chart = setChartBar(kategorien,werte,"einnahmen");
			einnahmenLayout.addComponent(chart, "top:10.0%;left:0.0%;");
			einnahmenLayout.addComponent(zeitraumSelect, "top:92.0%;left:0.0%");
			// Chart
			...
			chart = setChartBar(kategorien,werte,"Gesamtübersicht");
			gesamtLayout.addComponent(chart, "top:10.0%;left:0.0%;");
			gesamtLayout.addComponent(zeitraumSelect, "top:92.0%;left:0.0%");
			// Chart
			if (chartSelect.isSelected("ZeitÜberblick")) {
				zeitraumSelect.setVisible(true);
	...
	private Chart setChartBar(String[] kategorien, Double[] werte,String name) {
		...
		series.setData(test4); // als DOUBLE Array
		series2.setData(test5);
		conf.addSeries(series);
		conf.addSeries(series2);
		// Set the category labels on the axis correspondingly
		XAxis xaxis = new XAxis();
		xaxis.setCategories(test3); // als String Array
