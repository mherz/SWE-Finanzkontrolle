...
public class SeleniumEinnahmenGesamtUebersichtIntegrationTest {
  ...
  public void testSeleniumEinnahmenGesamtBersicht() throws Exception {
    ...
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if (isElementPresent(By.cssSelector("td.gwt-MenuItem.gwt-MenuItem-selected > span"))) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }
