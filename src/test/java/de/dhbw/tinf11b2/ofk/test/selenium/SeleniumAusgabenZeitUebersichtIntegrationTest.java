...
public class SeleniumAusgabenZeitUebersichtIntegrationTest {
  ...
  public void testSeleniumAusgabenZeitBersicht() throws Exception {
    ...
    driver.findElement(By.xpath("//div[@id='ofkcore-1544256749']/div/div[2]/div/div/div/div[2]/div/div/table/tbody/tr/td[3]/div/div/div")).click();
    driver.findElement(By.cssSelector("span.v-button-caption")).click();
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if (isElementPresent(By.cssSelector("svg > rect"))) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }
