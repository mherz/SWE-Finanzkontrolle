...
public class SeleniumEingabenEingebenIntegrationTest {
  ...
  public void testSeleniumEingabenEingeben() throws Exception {
    ...
    driver.findElement(By.xpath("//div[@id='ofkcore-1544256749']/div/div[2]/div/div/div/div/div/div[4]/div/span")).click();
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
